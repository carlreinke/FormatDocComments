...
using static FormatDocComments.ColumnHelpers;

namespace FormatDocComments
{
    /// <summary>
    /// A formatter for C# documentation comments.
    /// </summary>
    public sealed class DocCommentFormatter
    {
        ...
        /// <summary>
        /// Determines the changes necessary to format the documentation comments in a specified
        /// document.
        /// </summary>
        /// <param name="document">The document to format the documentation comments in.</param>
        ...
        /// <returns>The changes that will format the documentation comments.</returns>
        ...
        /// <summary>
        /// Determines the changes necessary to format the documentation comments that overlap a
        /// specified span of a specified document.
        /// </summary>
        /// <param name="document">The document to format the documentation comments in.</param>
        /// <param name="span">The span to format in the document.  documentation comments that
        ...
        /// <param name="cancellationToken">The cancellation token to observe.</param>
        /// <returns>The changes that will format the documentation comment.</returns>
...
#pragma warning restore CA1704 // Identifiers should be spelled correctly
        ...
        /// <summary>
        /// The documentation comment element formatting control flags.
        /// </summary>
        [Flags]
        ...
        private sealed class DocCommentFinder : CSharpSyntaxWalker
        {
            ...
            private DocCommentFinder(TextSpan selectionSpan)
            ...
            {
                // Find the DocumentationComment nodes.
                var syntaxWalker = new DocCommentFinder(rootNode.FullSpan);
            ...
            public static IEnumerable<DocumentationCommentTriviaSyntax> FindNodes(SyntaxNode node, TextSpan span)
            {
                ...
                // Find the DocumentationComment nodes that overlap the selection span.
                var syntaxWalker = new DocCommentFinder(span);
